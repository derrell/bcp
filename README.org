...
*** Tabs as mixins
Each tab in the user interface is implemented as a Mixin[fn::
Implementing each tab as a mixin was an experiment in this project. It
allows easy access to common code in one tab from another tab, but
