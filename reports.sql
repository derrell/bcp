...
(
 ...
 VALUES
(
  'Distribution appointments diapers needed',
  'Schedule of appointments for a specified distribution, including only families needing diapers',
  1,
  '{
     "$distribution" :
     {
