          ...
          Object.assign(
            {
              ...
              $language_abbreviation     : clientInfo.language_abbreviation,
              ...
              $diapers_needed            : clientInfo.diapers_needed,
          ...
          (distribution) =>
          {
            ...
            return this._db.prepare(
              [
                ...
                "    c.diapers_needed AS diapers_needed",
                "  FROM",
                "    Fulfillment f,",
                "    Client c,",
      ...
      return Promise.resolve()
        ...
        .then(() =>this._db.prepare(
          [
            ...
            "    f.family_name AS family_name,",
            "    cid.id AS id,",
            "    c.language_abbreviation AS language_abbreviation,",
            "    f.appt_day AS appt_day,",
            "    f.appt_time AS appt_time,",
            "    CASE f.appt_day",
            "      WHEN 1 THEN dp.day_1_date",
